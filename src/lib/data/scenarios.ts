...
export const ROLEPLAY_SCENARIOS: RolePlayScenario[] = [
  ...
  },
  {
    ...
    description: "Apresente-se em um evento profissional.",
    setting: "International professional networking event",
    aiRole: "Fellow professional at a networking mixer",
    studentRole: "Professional looking to expand their international network",
    openingLine: "Hi there! I don't think we've met. What brings you to this event today?",
  },
  {
    id: "coffee-chat",
    goal: "conversation",
